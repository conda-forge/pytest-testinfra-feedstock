...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-testinfra-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11681&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-testinfra-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-testinfra` can be installed with:

```
conda install pytest-testinfra
```

It is possible to list all of the versions of `pytest-testinfra` available on your platform with:
